...
#define SSI_CC_CS_SYSPLL        0x00000000  // Either the system clock (if the
                                            ...
                                            // PLL output (default)
#define SYSCTL_RCGCGPIO_SSI0       0x00000010  // SSI0 Clock Gating Control
#define SYSCTL_RCGCGPIO_GPIOA      0x00000001  // port A Clock Gating Control
...
void static commonInit(const uint8_t *cmdList) {
  ...
  while((SYSCTL_RCGCGPIO_R&0x01)==0){}; // allow time for clock to start
